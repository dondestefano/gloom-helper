...
export const CharacterHatchetPerks =
        [   // Perk 1
            ...
            addCards:[
                { id: "PlusTwoMuddle1", title: "+2 Muddle", img: plusTwoMuddle, backgroundColor: "#B88546" }
            ], 
            removeCards: [
            ...
            addCards:[
                { id: "PlusOneWound1", title: "+1 Wound", img: plusOneWound, backgroundColor: "#740001"}
            ], 
            removeCards: [
            ...
            addCards:[
                { id: "PlusOneImmobilize1", title: "+1 Immobilize", img: plusOneImmobilize, backgroundColor: "#f37735"}
            ], 
            removeCards: [
            ...
            addCards:[
                { id: "PlusOnePushTwo1", title: "+1 Push 2", img: plusOnePushTwo, backgroundColor: "#536872"}
            ], 
            removeCards: [
            ...
            addCards:[
                { id: "PlusZeroStun1", title: "+0 Stun", img: plusZeroStun, backgroundColor: "#0e1a40"}
            ], 
            removeCards: [
            ...
            addCards:[
                { id: "PlusOneStun1", title: "+1 Stun", img: plusOneStun, backgroundColor: "#0e1a40"}
            ], 
            removeCards: [
            ...
            addCards:[
                { id: "PlusTwoWind1", title: "+2 Wind", img: plusTwoWind, backgroundColor: "green"}
            ], 
            removeCards: []
            },
            ...
            perkRule: "Add one +2 Wind card", 
            addCards:[
                { id: "PlusTwoWind2", title: "+2 Wind", img: plusTwoWind, backgroundColor: "green"}
            ], 
            removeCards: []
            },
            ...
            perkRule: "Add one +2 Wind card", 
            addCards:[
                { id: "PlusTwoWind3", title: "+2 Wind", img: plusTwoWind, backgroundColor: "green"}
            ], 
            removeCards: []
            },
            ...
            perkRule: "Replace one +1 card with one +3 card", 
            addCards:[
                { id: "PlusThree2", title: "+3", img: plusThree, backgroundColor: "green"}
            ], 
            removeCards: [
            ...
            perkRule: "Replace one +1 card with one +3 card", 
            addCards:[
                { id: "PlusThree3", title: "+3", img: plusThree, backgroundColor: "green"}
            ], 
            removeCards: [
